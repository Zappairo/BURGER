...
if check_password():
    ...
    with col3:
        st.markdown(
            "<span style='color:gray;'><i>(À noter que tous les postes ne sont pas encore correctement répertoriés : environ 750 sur 2700 sont validés à 100 % - MAJ:04/07/2025)</i></span>",
            unsafe_allow_html=True
        )
